...
| SM-6.2 | **Confirm** (JRN-01.1.5 / JRN-01.3.3) | Redirected to list; new entry visible | Epic 6 (F6) | US-6.2: Verify Submitted Request Appears in List Immediately | JTBD-01.2 → Submitted request is visible in the list table within the same session; no manual reload required | R2 |
